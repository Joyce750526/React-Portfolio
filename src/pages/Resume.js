  ...
  return (
    <div className="container">
      <div className="container text-left">
        ...
        {/* Career Path Section */}
        <div className="col-lg-12">
          <h4 style={{ fontWeight: "normal" }}>Career Path</h4>
          ...
          <ul>
            <li>
              Basic IT knowledge training with hardware troubleshooting to help
              solve the issue
            </li>
            <li>
              Learned system administration: Windows Server and Active Directory
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              Redesigned Airbnb adding feature and share function on APP to make
              it more usable
            </li>
          </ul>
          <h6 style={{ fontWeight: "bold" }}>
            {" "}
            Holyoke Community College • The Accelerated English Course | Current
          </h6>
          <ul>
            <li>
        ...
        <div className="col-lg-12">
          ...
          <ul>
            ...
            <li>
              Onsite/online meetings with clients to go over the design process/
              options
            </li>
            <li>
          ...
          <ul>
            <li>
              Created 2D floor plans for cabinetry using in house software 20/20
              for clients
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              Structured bookmarks and created hyperlinks for navigation to all
              single drawing and to schematics into PDFs in Bluebeam Revu to
              meet DSA requirements
            </li>
          </ul>

          {/* Technical Skills Section */}
          <h4 style={{ fontWeight: "normal" }}>Technical Skills</h4>
          <h6 style={{ fontWeight: "bold" }}>Front-End Technologies</h6>
          <ol>
            <li>HTML</li>
            <li>CSS</li>
            <li>JavaScript</li>
          ...
          <h6 style={{ fontWeight: "bold" }}>Back-End Technologies</h6>
          <ol>
