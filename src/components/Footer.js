...
export default function Footer() {
  return (
    <div align="center">
      ...
      <a href="https://github.com/Joyce750526" target="_blank" rel="noreferrer">
        <Github color="black" size={20} />
      </a>
      
      {/* Hyberlinked LinkedIn Icon */}
      <a href="https://www.linkedin.com/in/joyce-chen-0526/" target="_blank" rel="noreferrer">
        <Linkedin color="blue" size={20} />
      </a>

      {/* Hyberlinked Email Icon */}
      <a href="mailto:joyceideas@outlook.com"> 
      <EnvelopeAtFill color="black" size={20} target="_blank" rel="noreferrer"/>
      </a>  
      ...
      {/* Copyright Text */}
      <p align="center" style={{ fontSize: "small" }}>© 2022 Copyright • Chao-Ying Chen</p>
